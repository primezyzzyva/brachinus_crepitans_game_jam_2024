...
function name_from_sprite_index(sprite_index)
{
	...
	switch (sprite_index)
	{
		...
		case sprite_mushroom_jelly: thy_name_is = "Vile Parasite Egg"; break;
		...
		case sprite_mushroom_mycelium: thy_name_is = "Mushroom Rich Compost"; break;
		...
		case sprite_vial_urine: thy_name_is = "Potent Pheromone"; break;
